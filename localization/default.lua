return {
    descriptions = {
        alt_texture = {
			...
			j_supernova = {
					name = "Ryunosuke's Death"
				},
				
			j_ride_the_bus = {
					name = "Mitchell Shepherd"
				},
			...
			j_luchador = {
					name = "Hot Purple Pikmin"
				},
				
			j_photograph = {
					name = "Video Game About Depression"
				},
